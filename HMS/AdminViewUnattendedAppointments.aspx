<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminViewUnattendedAppointments.aspx.cs" Inherits="HMS.AdminViewUnattendedAppointments" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Unattended Appointments</title>
...
<body>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Table ID="unattendedAppointmentsTable" CssClass="reportTable" runat="server">
                <asp:TableHeaderRow>
